          ...
          <div className="flex h-16 items-center justify-between">
            <div className="md:flex md:items-center md:gap-4">
              ...
              <div className="ml-[-200px] md:flex md:items-center md:gap-4 hidden">
                <Link
                  to={
                    "https://apps.apple.com/us/app/fake-wedding-make-love-pro/id6478814834"
                  }
                >
                  <img
                    src="img\512x512.png"
                ...
                <Link
                  to={
                    "https://play.google.com/store/apps/details?id=com.app.fakewedding"
                  }
                >
                  <img
                    src="img\512x5121.png"
                    className="object-contain h-10"
                    alt=""
                  />
                </Link>
                  ...
                  {isOpen ? (
                    <ul className="fixed inset-0 z-50 bg-white">
                      <button
                        ...
                        className="mt-7 absolute right-8"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                      ...
                      <div className="">
                        ...
                        >
                          <img
                            src="img\512x512.png"
                            alt=""
                            className="object-contain w-[30%] mx-auto mt-4"
                          />
                        </Link>
                        <Link
                          to={
