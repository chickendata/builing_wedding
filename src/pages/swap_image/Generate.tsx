      ...
      <div className="bg-[#F2FDFF]">
        ...
        <div className="md:pb-[70px] md:pt-[60px] pt-[30px] pb-[30px] md:w-[1440px] w-[390px]">
          <div className="flex md:h-[256px] md:ml-[160px] gap-6 ml-[33px] ">
            <div className="rounded-[20px] overflow-hidden md:w-[256px] w-[150px] md:mr-[50px]">
              <img
                ...
                src={`https://futurelove.online/${src_res_1.replace(
            ...
            <svg
              width="161"
              className="mt-[60px] hidden md:block"
              height="141"
              viewBox="0 0 161 141"
              fill="none"
            ...
            <div className="rounded-[20px] overflow-hidden md:w-[256px] w-[150px] md:ml-[50px]">
              <img
                className="w-full h-full object-cover"
                src={`https://futurelove.online/${src_res_2.replace(
                  "/var/www/build_futurelove/",
                  ""
                )}`}
                alt=""
            ...
            <div className="hidden md:block">
              <div className="ml-6 mt-[60px]">
                ...
                <br />
                <Button
                  onClick={() => navi(`/library/${user.id_user}`)}
                  variant={"cus3"}
                  className="w-[240px] h-[50px] mt-6"
                >
          ...
          <Button
            onClick={() => navi(-1)}
            variant={"cus3"}
            className="w-[330px] h-[50px] md:hidden my-4 ml-[30px]"
          >
          ...
          <Button
            onClick={() =>
              navi(`/library/${user.id_user}`, { state: { data } })
            }
            variant={"cus3"}
            className="w-[330px] h-[50px] md:hidden my-4 ml-[30px]"
          >
          ...
          <div className="md:ml-[160px] md:w-[1120px] w-[370px] md:mt-11 ml-[10px] md:block hidden">
            <div className="grid grid-cols-2 gap-6">
              <div className="">
                <img
                  className="w-full h-full object-cover"
                  onClick={() =>
                    handleDownloadImage(data.sukien_2_image.link_da_swap)
                  }
                  src={data.sukien_2_image.link_da_swap}
                  alt="aaa"
                />
              </div>
              <div className=" grid grid-cols-2 gap-6">
                <div className="">
                  <img
                    className="w-full h-full object-cover"
                    onClick={() => handleDownloadImage(data.link_anh_swap[0])}
                    src={data.link_anh_swap[0]}
                    alt="aaa"
                  />
                </div>
                <div className="">
                  <img
                    className="w-full h-full object-cover"
                    onClick={() => handleDownloadImage(data.link_anh_swap[1])}
                    src={data.link_anh_swap[1]}
                    alt=""
                  />
                </div>
                <div className="">
                  <img
                    className="w-full h-full object-cover"
                    onClick={() => handleDownloadImage(data.link_anh_swap[2])}
                    src={data.link_anh_swap[2]}
                    alt=""
                  />
                </div>
                <div className="">
                  <img
                    className="w-full h-full object-cover"
                    onClick={() => handleDownloadImage(data.link_anh_swap[3])}
                    src={data.link_anh_swap[3]}
                    alt=""
                  />
                </div>
              </div>
            ...
            <div className="grid grid-cols-3 md:w-[1120px] w-[370px] mt-6 gap-6">
              <div className="">
                <img
                  className="w-full h-full object-cover"
                  onClick={() => handleDownloadImage(data.link_anh_swap[4])}
                  src={data.link_anh_swap[4]}
                />
              </div>
              <div className="">
                <img
                  className="w-full h-full object-cover"
                  onClick={() => handleDownloadImage(data.link_anh_swap[5])}
                  src={data.link_anh_swap[5]}
                  alt=""
                />
              </div>
              <div className="">
                <img
                  className="w-full h-full object-cover"
                  onClick={() => handleDownloadImage(data.link_anh_swap[6])}
                  src={data.link_anh_swap[6]}
                  alt=""
                />
              </div>
              {seeMore &&
            ...
            <div className="grid grid-cols-2 gap-4">
              {data.link_anh_swap
                ...
                .map((img: string, index: number) => {
                  return (
                    <div
                      className="w-[175px] h-[205px] rounded-3xl overflow-hidden"
                      key={index}
                    >
                      <img
          ...
          <Button
            ...
            variant={"cus3"}
            className="md:w-[544px] w-[250px] h-[50px] mt-11 md:ml-[448px] ml-[55px] hidden md:block"
          >
            <span className="text-left">
              See {seeMore ? "less" : "more"} results
            </span>
          </Button>
        </div>
      </div>
