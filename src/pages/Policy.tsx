    ...
    <div className="text-center ">
        ...
        <div className="md:grid md:grid-cols-2">
          <div className="text-left p-11">
            <h1 className="text-center font-bold text-[40px]">
              Start with <span className="text-[#54ffc0]">Fake Wedding</span>
            </h1>
            <p className="text-[25px]">
              You want to know the future of you and your lover?, you want to
              have fun with a software that predicts your future, experience our
              artificial intelligence application, we are artificial
              intelligence software create future predictions, we will
              automatically generate your predictions, experience it, we will
              create future scenarios of love
            </p>
            <Button
              variant={"cus1"}
      ...
      <div className="mx-auto mt-11">
        <div className="md:grid md:grid-cols-2">
          ...
          <div className="text-left p-11">
            <h1 className="text-center font-bold text-[40px]">
              About <span className="text-[#54ffc0]">Us?</span>
            </h1>
            <p className="text-[25px]">
              You want to know the future of you and your lover?, you want to
              have fun with a software that predicts your future, experience our
        ...
        <div className="mx-auto text-left px-11">
          ...
          <p className="text-[25px] mt-4">
            ...
            “us,” and “our”) collects, uses, and shares your personal
          ...
          <div className="">
            ...
            <ul className="text-[#46b8ff] cursor-pointer">
              ...
              <li onClick={() => scrollToSection("section16")}>
                16. How do you use the collected face data? Provide a complete
                and clear explanation of all planned uses of this data.
              </li>
              <li onClick={() => scrollToSection("section17")}>
                17. Will the data be shared with any third parties? Where will
                this information be stored?Ï
              </li>
            ...
            <section id="section1">
              ...
              <p className="text-[25px] mt-4">
                ...
                us on our FutureLove mobile app, and our related online and
                offline offerings. To make this Privacy Notice easier to read,
                our FutureLove mobile app and our related offerings are
            ...
            <section id="section2">
              ...
              <p className="text-[25px] mt-4">
                ...
                and absolute discretion. If there are any material changes to
                this Privacy Notice, we will notify you as may be required by
                applicable law effective as of the date of such material changes
                becoming effective. You understand and agree that you will be
                deemed to have accepted the updated Privacy Notice if you
                continue to use our Services after the new Privacy Notice takes
                effect.
              </p>
            </section>
            <section id="section3">
            ...
            <section id="">
              ...
              <p className="text-[25px] mt-4">
                ...
                provide to us. (a) Biometric Data. Subject to your separate
                opt-in consent, we may collect biometric data from you including
                photos and videos of your face, including your facial geometry.
                You may opt out of our use of this data at any time by
                contacting us at the contact information provided below in
                Section 15. (b) Interactive Features. We and others who use our
                Services may collect personal information that you submit or
                make available through our interactive features (e.g., the
                content that you share and social media pages). Any information
                ...
                herein. (c) Purchases. As soon as FutureLove allows any
                purchases, we may collect personal information and details
                associated with your purchases, including payment information.
                In some cases, you may need to provide us with additional
                information to verify your identity before completing a
                transaction. Any payments made via our Services are processed by
                ...
                information (e.g., your billing details). (d) Your
                Communications with Us. We may collect personal information,
                such as email address and phone number when you request
                information about our Services, register to receive our
                newsletter or marketing, request customer or technical support,
                or otherwise communicate with us. (e) Surveys. We may contact
                you to participate in the surveys. If you decide to participate,
                you may be asked to provide certain information which may
                include personal information. (f) Sweepstakes or Contests. We
                may collect personal information you provide for any sweepstakes
                or contests that we offer. In some jurisdictions, we are
                required to publicly share information of sweepstakes and
                contest winners.
              </p>
            </section>
            <section id="">
              ...
              <p className="text-[25px] mt-4">
                ...
                our Services: (a) Automatic Data Collection. We may collect
                ...
                location information (including approximate location derived
                from IP address), Internet service provider, and metadata about
                the content you provide which can provide details such as the
                location of where a picture was taken. We may also automatically
                ...
                activities, your history of using the app history, and other
                information about how you use our Services. (b) Cookies, Pixel
                Tags/Web Beacons, and Other Technologies. We, as well as third
                parties that provide content, advertising, or other
                functionality on our Services, may use cookies, pixel tags,
                local storage, and other technologies (“Technologies”) to
                automatically collect information through your use of our
                Services. i. Cookies. Cookies are small text files placed in
                device browsers that store preferences and facilitate and
                enhance your experience. ii. Pixel Tags/Web Beacons. A pixel tag
                (also known as a web beacon) is a piece of code embedded in our
                ...
                clicked on a particular advertisement. We may also include web
                beacons in e-mails to understand whether messages have been
                opened, acted on, or forwarded. Our use of these Technologies
                fall into the following general categories: • Operationally
                Necessary. This includes Technologies that allow you access to
                our Services, applications, and tools that are required to
                identify irregular website behavior, prevent fraudulent activity
                and improve security or that allow you to make use of our
                functionality; • Performance-Related. We may use Technologies to
                ...
                Services (please see Analytics below); • Functionality-Related.
                ...
                items viewed; • Advertising- or Targeting-Related. We may use
                first party or third-party Technologies to deliver content,
                including ads relevant to your interests, on our Services or on
                third-party websites. Please see Section 6 below to understand
                your choices regarding these Technologies. (c) Analytics. We may
                use Technologies and other third-party tools to process
                analytics information on our Services. Some of our analytics
                partners include Google Firebase. For more information, please
                visit the Google Privacy Terms web page. To learn more about how
                to opt-out of Google’ use of your information on our mobile app,
            ...
            <section id="">
              ...
              <p className="text-[25px] mt-4">
                ...
                information about you from that third-party or third-party
            ...
            <section id="">
              ...
              <p className="text-[25px] mt-4">
                ...
                provide you with our Services, such as: Providing face(-s)
                animation on a photo or a picture features, and other similar
                Services; Managing your information and accounts; Providing
                access to certain areas, functionalities, and features of our
                Services; Answering requests for customer or technical support;
                Communicating with you about your account, activities on our
                Services, and policy changes; and Processing your financial
            ...
            <section id="">
              ...
              <p className="text-[25px] mt-4">
                ...
                such as: Pursuing our legitimate interests such as direct
                marketing, research and development (including marketing
                research), network and information security, and fraud
                prevention; Detecting security incidents, protecting against
                malicious, deceptive, fraudulent or illegal activity, and
                prosecuting those responsible for that activity; Measuring
                interest and engagement in our Services; Short-term, transient
                use, such as contextual customization of ads; Improving,
                upgrading or enhancing our Services; Developing new products and
                Services; Ensuring internal quality control and safety;
                Authenticating and verifying individual identities; Debugging to
                identify and repair errors with our Services; Auditing relating
                to interactions, transactions and other compliance activities;
                Enforcing our agreements and policies; and Complying with our
                legal obligations.
              </p>
            </section>
            <section id="">
              ...
              <p className="text-[25px] mt-4">
                ...
                may market to you include email campaigns, custom audiences
                advertising, and “interest-based” or “personalized advertising,”
                including through cross-device tracking. If you have any
                questions about our marketing practices or if you would like to
                opt out of the use of your personal information for marketing
                purposes, you may contact us at any time as set forth in Section
                15 below.
              </p>
            </section>
            <section id="">
              ...
              <p className="text-[25px] mt-4">
                We may use personal information and other information about you
                to create de-identified and/or aggregated information, such as
              ...
              <p className="text-[25px] mt-4">
                ...
                friends or colleagues through our referral services. Our
            ...
            <section id="">
              ...
              <p className="text-[25px] mt-4">
                ...
                information are described below. a Other Users or Third Parties.
                When you use the Services, you may choose to share personal
                information or content with other users or third parties. In
                addition, certain aspects of your profile may be available to
                other users. b Service Providers. We may share your personal
                ...
                payment processing, customer service, and related services. c
                ...
                have requested. We may also share your personal information with
                business partners with whom we jointly offer products or
                services. d Advertising Partners. We may share your personal
                information, except for your biometric data, with third-party
                ...
                This practice is commonly referred to as “interest-based
                advertising” or “personalized advertising.” e APIs/SDKs. We may
                use third-party application program interfaces (“APIs”) and
                software development kits (“SDKs”) as part of the functionality
                of our Services. For more information about our use of APIs and
            ...
            <section id="">
              ...
              <p className="text-[25px] mt-4">
                ...
                are determined by applicable law and are described below. (a)
                Email Communications. If you receive an unwanted email from us,
                you can use the unsubscribe link found at the bottom of the
                ...
                updates to our Terms of Use or this Privacy Notice). (b) Text
                Messages. You may opt out of receiving text messages from us by
                following the instructions in the text message you have received
                from us or by otherwise contacting us. (c) Mobile Devices. We
                may send you push notifications through our mobile app. You may
                opt out from receiving these push notifications by changing the
                settings on your mobile device. With your consent, we may also
                collect precise location-based information via our mobile app.
                You may opt out of this collection by changing the settings on
                your mobile device. (d) “Do Not Track.” Do Not Track (“DNT”) is
                a privacy preference that users can set in certain web browsers.
                Please note that we do not respond to or honor DNT signals or
                similar mechanisms transmitted by web browsers. (e) Cookies and
                Interest-Based Advertising. You may stop or restrict the
                placement of Technologies on your device or remove them by
                adjusting your preferences as your browser or device permits.
                However, if you adjust your preferences, our Services may not
                work properly. Please note that cookie-based opt-outs are not
                effective on mobile applications. However, you may opt-out of
                personalized advertisements on some mobile applications by
                following the instructions for Android, iOS and others. The
                online advertising industry also provides websites from which
                ...
                Network Advertising Initiative, the Digital Advertising
                Alliance, the European Digital Advertising Alliance, and the
                Digital Advertising Alliance of Canada. Please note you must
                separately opt out in each browser and on each device.
              </p>
            </section>
            <section id="">
              <h1 className="mt-11 font-bold text-[25px]">
              ...
              <p className="text-[25px] mt-4">
                ...
                (a) Request access to your personal data: Commonly known as a
                “data subject access request,” this enables you to receive a
                copy of the personal data we hold about you and to verify that
                we are lawfully processing it. (b) Request correction of the
                ...
                provide to us. (c) Request erasure of your personal data: This
                enables you to ask us to delete or remove personal data where
                there is no good reason for us to continue processing it. You
                ...
                may not always be able to comply with your request for erasure
                for specific legal reasons, which will be notified to you, if
                applicable, at the time of your request. (d) Object to
                processing of your personal data: This applies when we are
                relying on a legitimate interest (or those of a third party) and
                there is something about your particular situation that makes
                ...
                information which override your rights and freedoms. (e) Request
                restriction of processing of your personal data: This enables
                you to ask us to suspend the processing of your personal data in
                the following scenarios: i. If you want us to establish the
                data’s accuracy; ii. Where our use of the data is unlawful but
                you do not want us to erase it; iii. Where you need us to hold
                the data even if we no longer require it as you need it to
                establish, exercise, or defend legal claims; or iv. You have
                objected to our use of your data but we need to verify whether
                we have overriding legitimate grounds to use it. (f) Request the
                transfer of your personal data: We will provide your personal
                data in a structured, commonly used, machine-readable format to
                you or a third party you have chosen. Please note that this
                right only applies to automated information which you initially
                provided consent for us to use or where we used the information
                to perform a contract with you. (g) Withdraw consent: You may
            ...
            <section id="section7">
              ...
              <p className="text-[25px] mt-4">
                ...
                and administrative issues relating to your use of our Services.
                If we learn of a security system’s breach, we may attempt to
                notify you electronically by posting a notice on our Services,
            ...
            <section id="section8">
              ...
              <p className="text-[25px] mt-4">
                ...
                their processing of your personal data will involve a transfer
                of data outside the UK. We may transfer your personal data to
                our group companies that are located outside the UK, including,
                but not limited, in the United States, or other countries, which
                may have data protection laws that are different from the laws
                where you live. Whenever we transfer your personal data out of
                the UK, we ensure a similar degree of protection is afforded to
                it by ensuring at least one of the following safeguards is
                implemented: (a) We will only transfer your personal data to
                countries that have been deemed to provide an adequate level of
                protection for personal data. (b) Where we use certain service
                providers, we may use specific contracts approved by the UK
            ...
            <section id="section9">
              ...
              <p className="text-[25px] mt-4">
                ...
                Notwithstanding the foregoing, we may store biometric data for
                three (3) years.
              </p>
            </section>
            <section id="section10">
              ...
              <p className="text-[25px] mt-4">
                ...
                processing of personal information that is subject to the
                California Consumer Privacy Act of 2018 (“CCPA”). The CCPA
                provides California residents with the right to know what
                categories of personal information a person (either a natural
                person or a legal entity) has collected about them and whether
                such person disclosed that personal information for a business
                purpose (e.g., to a service provider) in the preceding twelve
              ...
              <h1 className="mt-11 font-bold text-[25px]">
                Categories of Third Parties Personal Information is Disclosed to
              ...
              <p className="text-[25px] mt-4">
                ...
                the CCPA, we do not “sell” personal information, nor do we have
                actual knowledge of any “sale” of personal information of minors
                ...
                rights conferred by the CCPA. <br />
                Authorized Agent. Only you, or someone legally authorized to act
                on your behalf, may make a verifiable consumer request related
                to your personal information. To designate an authorized agent,
                please contact us as set forth below. <br />
                ...
                information we have about you. <br />
                ...
                Section 15 below. We will process such requests in accordance
            ...
            <section id="section11">
              ...
              <p className="text-[25px] mt-4">
                ...
                exercise this right by contacting us as set forth in Section 15
                below with the subject line “Nevada Do Not Sell Request” and
            ...
            <section id="section12">
              ...
              <p className="text-[25px] mt-4">
                ...
                you may contact us as set forth in Section 15 below. If we learn
            ...
            <section id="section14">
              ...
              <p className="text-[25px] mt-4">
                If you are located in the Ha Noi Vietnam, you have the right to
                lodge a complaint with a supervisory authority if you believe
                our processing of your personal information violates applicable
                law. The full list of authorities on the protection of personal
                data in each Vietnam member state.
              </p>
            </section>
            <section id="section15">
              ...
              <p className="text-[25px] mt-4">
                ⇒ Our application takes a photo of a face without makeup,
                without glasses, without a mask. Our application will take a
                photo of a man and 1 photo of a woman to create a pairing event.
                Take a look at our running results
                here:https://futurelove.online/detail/920980354218/1
              </p>
            </section>
            <section id="section16">
              ...
              <p className="text-[25px] mt-4">
                ⇒ Our application will take a frontal photo of the face, build a
                3D model of it, then swap the face into another photo. Note that
                we will not store the face, we will upload the photo to a
                temporary server. It will serve to generate modal and swap
                faces, we do not store images data for a long time. These face
                images will be deleted immediately after users download or close
                the application.
              </p>
            </section>
            <section id="section17">
              <h1 className="mt-11 font-bold text-[40px]">
                17. Will the data be shared with any third parties? Where will
                this information be stored?
              </h1>
              <p className="text-[25px] mt-4">
                ⇒ We do not share user data with any third parties, unless users
                want to do that via any other application like social media.
                This information is stored in the user's device. We will only
                temporarily store this data on an intermediary server and if the
                user does not want anyone else to store this data in the future,
                they can delete it.
              </p>
            </section>
            <section id="section18">
              ...
              <p className="text-[25px] mt-4">
                - Face data will be stored if the user wishes, our application
                logic is to allow users to store a web link list of events
                created by AI so that users can share online, share love between
                people. 2 people, to share with friends who are interested, it
                may be saved for 3-4 month as the user's right, if the user
                deletes the account, it will be lost, the data will disappear if
            ...
            <section id="section19">
              ...
              <p className="text-[25px] mt-4">
                Thinkdiff AI Company is the controller of your personal
                information. If you have any questions about our privacy
                practices or this Privacy Notice, or to exercise your rights as
                detailed in this Privacy Notice, please contact us at: <br />
