    ...
    <>
      <div className="bg-[#F2FDFF]">
        ...
        <div className="pb-[70px] pt-[40px]">
          ...
          <h5 className="font-[400] italic md:text-[20px] text-[16px] leading-[20px] mt-[10px] md:ml-[210px] mb-7  ml-7">
            {valueLocation.geoplugin_city === "Hanoi"
              ? "Tất cả ảnh được thay đổi đã sẵn sàng!!!!! "
              : "All swapped image events is alreadyyyy!!"}
