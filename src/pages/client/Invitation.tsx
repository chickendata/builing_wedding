...
function Invitation() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://databaseswap.mangasocial.online/images/${user.id_user}?type=video`,
        {
          headers: {
  ...
  /**
   * when click button "create" if 2 image are uploaded will send to server
   */
  ...
  /*
   *
   * when click button "Create" if 2 image was uploaded, will send to server
   */
        ...
        <div className="text-center items-center justify-center">
          ...
          <div className="flex gap-3 ml-2 md:ml-0">
            <div
              ...
              className="md:w-[256px] md:h-[256px] w-[116px] flex items-center text-center justify-center rounded-xl border md:bg-white border-gray-100 shadow-xl hover-ring-1 hover-ring-gray focus-outline-none focus-ring"
            >
              <input
        ...
        <div className="">
          ...
          <div className="flex gap-3 ml-2 md:ml-0">
            <div
              ...
              className="md:w-[256px] md:h-[256px] w-[116px] flex text-center items-center justify-center rounded-xl border md:bg-white border-gray-100 shadow-xl hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring"
            >
              <input
