...
const ListCategory = () => {
  ...
  const [listTemp, setListTemp] = useState<listItemType[] | []>([
    { id_cate: 0, name_cate: "", image_sample: "" },
  ]);
  useEffect(() => {
    axios
      .get(`https://databaseswap.mangasocial.online/get/categories_wedding`)
      .then((res) => {
        ...
        <div className="pb-[70px] pt-[40px]">
          ...
          <div className="mx-auto p-[24px] md:w-[1020px] rounded-xl border bg-white border-gray-100 shadow-xl hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring gap-8 items-center justify-center mt-11">
            <div className="">
              ...
              <h5 className="font-[400] italic md:text-[20px] text-[16px] leading-[20px] text-center mt-[10px]">
                Choose a Category that's right for you to start creating these
