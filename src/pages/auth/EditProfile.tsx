    ...
    <>
      <div className="bg-[#F2FDFF]">
        ...
        <div className="pb-[70px] pt-[40px]">
          ...
          <h1 className="font-[600] text-[40px] leading-[48px] md:ml-[210px] m-[30px] mb-[30px] mt-[10px]">
            Profile
          </h1>
              ...
              <div className="bg-white">
                <ul className="space-y-2 font-medium">
                  <li>
                    <Link
                      to={`/profile/${id}`}
                      className="flex items-center p-2 text-slate-500 hover:text-black rounded-lg  hover:bg-gray-100  group"
                    >
                      <span className="ms-3">
                  ...
                  <li>
                    <span
                      ...
                      className="flex cursor-pointer items-center p-2 text-slate-500 hover:text-black rounded-lg hover:bg-gray-100  group"
                    >
            ...
            <div className="md:hidden">
              <DropdownMenu>
                <DropdownMenuTrigger asChild className="mx-auto">
                  <Button
                    variant="outline2"
                    className="w-[345px] justify-between ml-6 mt-3 outline-none"
                  >
                ...
                <DropdownMenuContent className="w-[345px] bg-white p-2">
                  <DropdownMenuSeparator />
                  <DropdownMenuCheckboxItem className="w-full bg-[#fff] hover:bg-accent hover:text-accent-foreground p-2 rounded-lg">
                    <Link to={`/profile/${id}`}>
                      <button>
                        {valueLocation.geoplugin_city === "Hanoi"
                          ? "Hồ sơ"
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuCheckboxItem className="w-full bg-[#fff] hover:bg-accent hover:text-accent-foreground p-2 rounded-lg mt-2">
                    <Link to={`edit/${id}`}>
                      <button onClick={() => handleChangeFunc("Edit Profile")}>
                        {" "}
                        {valueLocation.geoplugin_city === "Hanoi"
                          ? "Hồ sơ"
                          : "My profile"}
                  ...
                  <DropdownMenuCheckboxItem className="w-full bg-[#fff] hover:bg-accent hover:text-accent-foreground p-2 rounded-lg mt-2">
                    <Link to={`account/${id}`}>
                      <button
                        onClick={() => handleChangeFunc("Change Password")}
                      >
                        {valueLocation.geoplugin_city === "Hanoi"
                          ? "Thay đổi mật khẩu"
                          : "Change password"}
