        ...
        <div className="mx-auto md:w-[602px] max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-lg md:mt-[260px] mt-[100px]">
            ...
            >
              ...
              <h4 className="text-sm text-black font-[600] mb-[15px]">
                {valueLocation.geoplugin_city === "Hanoi"
                  ? "Đừng lo lắng, chúng tôi sẽ cài lại mật khẩu cho bạn"
                  : "Don't worries, we will reset your password now?"}
              </h4>
              ...
              >
                {valueLocation.geoplugin_city === "Hanoi" ? "Gửi" : "Send"}
              </button>
              <Link className="flex md:ml-[150px] ml-[80px]" to={`/signin`}>
                ...
                <span className="text-[14px] font-bold text-black leading-4">
                  {valueLocation.geoplugin_city === "Hanoi"
