...
const Signin = () => {
  ...
  const [pwClasslist, setPwClasslist] = useState(
    "focus:outline-none w-full rounded-lg border-gray-200 p-4 ps-12 text-sm shadow-sm bg-[#F4F4F4]"
  );
  const [emClasslist, setEmClasslist] = useState(
    "focus:outline-none w-full rounded-lg border-gray-200 p-4 ps-12 text-sm shadow-sm bg-[#F4F4F4]"
  );
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (!email) {
      setEmClasslist(
        "focus:outline-none w-full border-solid border-4 rounded-lg border-[#FF6A55] p-4 ps-12 text-sm shadow-sm bg-[#FFEDE4]"
      );
    ...
    <div className="md:w-[1440px] w-[390px] mx-auto">
      <div className="md:grid grid-cols-2">
        <div className="bg-[#F2FDFF] items-center md:w-[750px] w-[390px]">
          ...
          <img
            className="px-[29px] mt-[150px] mb-[90px] md:block hidden"
            src="img\signin.png"
            alt=""
          />
        </div>
        <div className="mx-auto md:w-[602px] max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-lg md:mt-[180px] mt-[60px]">
            ...
            >
              <h1 className="text-2xl font-bold text-[#2A85FF]-600 sm:text-3xl">
                Sign In
              </h1>
              ...
              <div>
                ...
                <span className="text-[#FF6A55] font-[600] text-[13px] ml-2">
                  {noticeEm}
                </span>
              </div>
